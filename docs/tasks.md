...
- [x] Add a right-side Build drawer sourced from `docs/notes/assembly-instructions.md` and `docs/notes/product-characteristics.md`.
...
- [x] Review and revise landing-page copy in the migrated Vite page; the current visual style and colour direction are liked, but some wording is intentionally pending.
...
- [x] Split the lazy hero cube app code from the Three.js vendor payload in the production build.
- [x] Add a latest-firmware download path for `tcube-pi` releases to the landing build section and Build drawer.
- [x] Replace the separate Build page shell with an in-page right-side drawer.
- [x] Add a separate LLM operators drawer for speech generation, learning flow, and `learning.md`.
...
- [x] Create or restore `docs/developer/README.md`, which is referenced by `AGENTS.md` but currently missing.
- [x] Replace `README.md` placeholder content with a short project overview, local setup, validation commands, and links to the developer docs.
