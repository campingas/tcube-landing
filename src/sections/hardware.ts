  ...
  <div class="container mx-auto px-rhythm-3 py-rhythm-13 border-t border-wada-slate/40" data-reveal>
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-rhythm-8 items-center">
      ...
      <div class="lg:col-span-6 order-2 lg:order-1 flex justify-center">
        <div class="w-full max-w-lg bg-gradient-to-br from-wada-slate to-wada-ink/50 border-2 border-wada-salmon/20 rounded-2xl p-rhythm-3 shadow-2xl relative overflow-hidden flex flex-col justify-between h-[420px]">
          ...
          <div class="z-10 flex justify-between items-center pb-rhythm-2 border-b border-wada-moss/20">
            ...
            <span class="px-2 py-0.5 rounded bg-wada-teal/10 border border-wada-teal/30 text-wada-teal font-mono text-[8px] uppercase tracking-widest">Open build</span>
          </div>
          
          <!-- Board representation layout -->
          <div class="z-10 my-rhythm-3 flex-1 flex items-center justify-center relative">
            <div class="w-size-god h-[200px] border border-wada-moss/30 rounded-xl bg-wada-ink/60 flex flex-col justify-between p-rhythm-2 text-[10px] font-mono text-wada-paper/75 leading-relaxed">
              <div class="flex justify-between items-start">
                <span class="text-wada-teal">// RASPBERRY PI ZERO 2W</span>
              ...
              <div class="flex justify-between items-end text-[9px]">
                <span>Firmware: open source</span>
                <span class="text-wada-teal">I2S audio output</span>
              </div>
            </div>
          </div>
          
          <!-- Specifications Footer -->
          <div class="z-10 pt-rhythm-2 border-t border-wada-moss/20 flex justify-between items-center text-[10px] font-mono text-wada-paper/75">
      ...
      <div class="lg:col-span-6 order-1 lg:order-2 flex flex-col items-start">
        <span class="text-wada-salmon text-caption font-mono uppercase tracking-widest block mb-rhythm-2">Maker orbit</span>
        <h2 class="font-display text-display-h2 text-wada-teal font-bold mb-rhythm-3">
          Open hardware, clearly shown.
        </h2>
        <p class="text-wada-paper text-lead mb-rhythm-5 font-body">
          The build is open, the parts are standard, and the result is easy to trust.
        </p>
        <p class="text-wada-paper/85 text-body font-body mb-rhythm-8">
          T-Cube uses a Raspberry Pi Zero 2W, a PCM5102 I2S DAC, a speaker, and tactile buttons. Parents can see what is inside and makers can reproduce it.
        </p>
