    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-rhythm-8 items-center">
      ...
      <div class="lg:col-span-7 flex flex-col items-start text-left">
        <h1 class="font-display text-display-hero text-wada-paper font-bold leading-none mb-rhythm-3">
          T-Cube teaches by listening.
        </h1>
        
        <p class="text-lead text-wada-paper/90 font-body max-w-2xl mb-rhythm-8">
          T-Cube is a screen-free device that reads short English sentences aloud to children. They press a button, listen, and learn in a calm, tactile way.
        </p>
        ...
        <div class="w-size-god h-size-god rounded-3xl bg-gradient-to-br from-wada-slate to-wada-ink border-2 border-wada-salmon/40 shadow-2xl p-rhythm-3 flex flex-col justify-between items-center relative select-none">
          ...
          <div class="w-full flex justify-between items-center px-rhythm-1">
            ...
            <div class="flex items-center gap-rhythm-1">
              <span id="simulator-led-text" class="text-caption font-mono text-wada-paper/70 text-[8px] uppercase">Standby</span>
          ...
          <div class="w-full">
            <p class="text-center text-caption font-mono text-wada-paper/70 mb-rhythm-2 uppercase tracking-wide">
            ...
            <div class="grid grid-cols-3 gap-rhythm-2 max-w-[240px] mx-auto">
              <button data-voice="intro" class="sim-btn aspect-square rounded-lg bg-wada-ink border border-wada-moss/30 hover:border-wada-teal hover:text-wada-teal text-wada-paper font-display font-semibold transition-all duration-200 transform hover:scale-105 active:scale-95 focus:ring-1 focus:ring-wada-teal focus:outline-none flex flex-col justify-center items-center p-1">
                ...
                <span class="text-[8px] font-mono uppercase tracking-widest text-wada-paper/70">Hello</span>
              </button>
              <button data-voice="sentence" class="sim-btn aspect-square rounded-lg bg-wada-ink border border-wada-moss/30 hover:border-wada-teal hover:text-wada-teal text-wada-paper font-display font-semibold transition-all duration-200 transform hover:scale-105 active:scale-95 focus:ring-1 focus:ring-wada-teal focus:outline-none flex flex-col justify-center items-center p-1">
                <span class="text-lead">📖</span>
                <span class="text-[8px] font-mono uppercase tracking-widest text-wada-paper/70">Sentence</span>
              </button>
              <button data-voice="recording" class="sim-btn aspect-square rounded-lg bg-wada-ink border border-wada-moss/30 hover:border-wada-teal hover:text-wada-teal text-wada-paper font-display font-semibold transition-all duration-200 transform hover:scale-105 active:scale-95 focus:ring-1 focus:ring-wada-teal focus:outline-none flex flex-col justify-center items-center p-1">
                <span class="text-lead">🎵</span>
                <span class="text-[8px] font-mono uppercase tracking-widest text-wada-paper/70">Record</span>
              </button>
              
              <button data-voice="lesson_en" class="sim-btn aspect-square rounded-lg bg-wada-ink border border-wada-moss/30 hover:border-wada-teal hover:text-wada-teal text-wada-paper font-display font-semibold transition-all duration-200 transform hover:scale-105 active:scale-95 focus:ring-1 focus:ring-wada-teal focus:outline-none flex flex-col justify-center items-center p-1">
                <span class="text-lead">🔤</span>
                <span class="text-[8px] font-mono uppercase tracking-widest text-wada-paper/70">Lesson</span>
              </button>
              <button data-voice="quiz" class="sim-btn aspect-square rounded-lg bg-wada-ink border border-wada-moss/30 hover:border-wada-teal hover:text-wada-teal text-wada-paper font-display font-semibold transition-all duration-200 transform hover:scale-105 active:scale-95 focus:ring-1 focus:ring-wada-teal focus:outline-none flex flex-col justify-center items-center p-1">
                <span class="text-lead">❓</span>
                <span class="text-[8px] font-mono uppercase tracking-widest text-wada-paper/70">Prompt</span>
              </button>
              <button data-voice="generated" class="sim-btn aspect-square rounded-lg bg-wada-ink border border-wada-moss/30 hover:border-wada-teal hover:text-wada-teal text-wada-paper font-display font-semibold transition-all duration-200 transform hover:scale-105 active:scale-95 focus:ring-1 focus:ring-wada-teal focus:outline-none flex flex-col justify-center items-center p-1">
                <span class="text-lead">🌸</span>
                <span class="text-[8px] font-mono uppercase tracking-widest text-wada-paper/70">Generate</span>
              </button>
            </div>
          </div>
        </div>
...
const voiceLines: Record<string, { text: string; label: string; ledColor: string }> = {
  intro: {
    text: '"Hello. I am T-Cube. Press a button and I will read aloud."',
    label: 'Ready',
    ledColor: 'bg-wada-teal',
  },
  sentence: {
    text: '"The sun is warm. The little cube is ready."',
    label: 'Sentence',
    ledColor: 'bg-wada-rufous',
  },
  recording: {
    text: '"This is a saved recording. Listen once, then repeat it."',
    label: 'Recording',
    ledColor: 'bg-wada-teal',
  },
  lesson_en: {
    text: '"Today we learn one word: family. My family reads with me."',
    label: 'Lesson',
    ledColor: 'bg-wada-salmon',
  },
  quiz: {
    text: '"Say it after me: I can listen. I can learn."',
    label: 'Prompt',
    ledColor: 'bg-wada-rufous',
  },
  generated: {
    text: '"Generated sentence: The blue button starts a new word."',
    label: 'Generated',
    ledColor: 'bg-wada-teal',
  },
}
